...
namespace HomeWork_17_WPF.View {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ClientsDataTable : global::System.Data.TypedTableBase<ClientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientsRow AddClientsRow(string Name, int Money, int Department, int Deposit) {
        ...
        public partial class ClientsRow : global::System.Data.DataRow {
            ...
            public int Department {
                get {
                    return ((int)(this[this.tableClients.DepartmentColumn]));
                }
                set {
                    this[this.tableClients.DepartmentColumn] = value;
                }
            }
            ...
            public int Deposit {
                get {
                    return ((int)(this[this.tableClients.DepositColumn]));
                }
                set {
                    this[this.tableClients.DepositColumn] = value;
                }
            }
        }
...
namespace HomeWork_17_WPF.View.DataSet1TableAdapters {
    ...
    public partial class ClientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Clients] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_" +
                "Name) AND ([Money] = @Original_Money) AND ([Department] = @Original_Department) " +
                "AND ([Deposit] = @Original_Deposit))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clients] ([Name], [Money], [Department], [Deposit]) VALUES (@N" +
                "ame, @Money, @Department, @Deposit);\r\nSELECT Id, Name, Money, Department, Deposi" +
                "t FROM Clients WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clients] SET [Name] = @Name, [Money] = @Money, [Department] = @Department, [Deposit] = @Deposit WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Money] = @Original_Money) AND ([Department] = @Original_Department) AND ([Deposit] = @Original_Deposit));
SELECT Id, Name, Money, Department, Deposit FROM Clients WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HomeWork_17_WPF.Properties.Settings.Default.bankConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Money, Department, Deposit FROM dbo.Clients";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Money, int Original_Department, int Original_Deposit) {
        ...
        public virtual int Insert(string Name, int Money, int Department, int Deposit) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Deposit));
        ...
        public virtual int Update(string Name, int Money, int Department, int Deposit, int Original_Id, string Original_Name, int Original_Money, int Original_Department, int Original_Deposit, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Deposit));
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Deposit));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Money, int Department, int Deposit, int Original_Id, string Original_Name, int Original_Money, int Original_Department, int Original_Deposit) {
            return this.Update(Name, Money, Department, Deposit, Original_Id, Original_Name, Original_Money, Original_Department, Original_Deposit, Original_Id);
        }
    }
